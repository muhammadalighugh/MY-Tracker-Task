...
const MobileNavDropdown = () => (
  <div className="lg:hidden bg-white rounded-lg shadow-lg border border-slate-200 p-2 absolute top-full right-0 z-50 mt-1 min-w-[200px]">
    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="mb-4 md:mb-2 relative">
        <div className="border-b border-slate-200 bg-white rounded-t-xl shadow-sm">
          <nav className="-mb-px flex overflow-x-auto px-3 md:px-6">
            ...
            <button
              ...
              className={`lg:hidden flex items-center gap-1 py-3 md:py-4 px-2 md:px-4 text-xs md:text-sm font-medium border-b-2 transition-colors duration-200 whitespace-nowrap ${
